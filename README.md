...
Singer-compliant target for loading data into Oracle Warehouse Management Systems (WMS). Built with Python 3.13+, Clean Architecture, and Domain-Driven Design patterns as part of the [FLEXT data integration platform](https://github.com/flext-sh/flext).
