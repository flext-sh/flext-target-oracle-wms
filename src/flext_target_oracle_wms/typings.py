...
class FlextTargetOracleWmsTypes(FlextMeltanoTypes, FlextOracleWmsTypes):
    ...
    class TargetOracleWms:
        ...
        type StreamConfiguration = Mapping[
            str, str | bool | Mapping[str, FlextOracleWmsTypes.Container]
        ]
        type MessageProcessing = Mapping[
            str, str | Sequence[Mapping[str, FlextOracleWmsTypes.Container]]
        ]
        type RecordHandling = Mapping[
            str, str | Mapping[str, FlextOracleWmsTypes.Container] | bool
        ]
        type StateManagement = Mapping[
            str, str | Mapping[str, FlextOracleWmsTypes.Container]
        ]
        type BatchProcessing = Mapping[
            str, str | int | Mapping[str, FlextOracleWmsTypes.Container]
        ]
    ...
    class WmsInventory:
        ...
        type StockLevelTracking = Mapping[
            str, int | float | Mapping[str, FlextOracleWmsTypes.Container]
        ]
        type AllocationManagement = Mapping[
            str, int | str | Mapping[str, FlextOracleWmsTypes.Container]
        ]
    ...
    class WmsOrderManagement:
        ...
        type ShippingConfiguration = Mapping[
            str, bool | str | Mapping[str, FlextOracleWmsTypes.Container]
        ]
    ...
    class WmsLaborManagement:
        ...
        type ProductivityMetrics = Mapping[
            str, float | int | Mapping[str, FlextOracleWmsTypes.Container]
        ]
    ...
    class StreamProcessing:
        ...
        type StreamConfiguration = Mapping[
            str, str | bool | int | Mapping[str, FlextOracleWmsTypes.Container]
        ]
    ...
    class ErrorHandling:
        ...
        type ErrorConfiguration = Mapping[
            str, bool | str | int | Mapping[str, FlextOracleWmsTypes.Container]
        ]
    ...
    class Project:
        ...
        type SingerTargetOracleWmsProjectConfig = Mapping[
            str, FlextOracleWmsTypes.Container
        ]
