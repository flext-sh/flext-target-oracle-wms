...
class FlextTargetOracleWmsTypes(FlextMeltanoTypes, FlextOracleWmsTypes):
    ...
    class WmsInventory:
        ...
        type StockLevelTracking = dict[
            str, int | float | dict[str, FlextMeltanoTypes.ContainerValue]
        ]
        type AllocationManagement = dict[
            str, int | str | dict[str, FlextMeltanoTypes.ContainerValue]
        ]
    ...
    class WmsLaborManagement:
        ...
        type ProductivityMetrics = dict[
            str, float | int | dict[str, FlextMeltanoTypes.ContainerValue]
        ]
