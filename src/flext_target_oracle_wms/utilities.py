...
class FlextTargetOracleWmsUtilities(FlextMeltanoUtilities, FlextOracleWmsUtilities):
    ...
    class WMSDataTransformer:
        ...
        def transform_record(
            self,
            record_message: m.Meltano.SingerRecordMessage | dict[str, t.ContainerValue],
...
class WMSTypeConverter(FlextTargetOracleWmsUtilities.WMSTypeConverter):
    """Module-level alias for backwards compatibility."""

    pass


class WMSDataTransformer(FlextTargetOracleWmsUtilities.WMSDataTransformer):
    """Module-level alias for backwards compatibility."""

    pass


class WMSSchemaMapper(FlextTargetOracleWmsUtilities.WMSSchemaMapper):
    """Module-level alias for backwards compatibility."""

    pass


class WMSTableManager(FlextTargetOracleWmsUtilities.WMSTableManager):
    """Module-level alias for backwards compatibility."""
