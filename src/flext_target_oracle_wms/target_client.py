...
class SingerWMSCatalogEntry(FlextCore.Config):
    """Singer WMS catalog entry using flext-core patterns."""

    tap_stream_id: str
    stream: str
    schema_info: FlextCore.Types.Dict
    metadata: list[FlextCore.Types.Dict] = Field(default_factory=list)
    key_properties: FlextCore.Types.StringList = Field(default_factory=list)
    bookmark_properties: FlextCore.Types.StringList = Field(default_factory=list)
    ...
    def validate_domain_rules(self: object) -> FlextCore.Result[None]:
        ...
        try:
            ...
            if not self.schema_info:
                return FlextCore.Result[None].fail("schema_info cannot be empty")
...
class SingerWMSCatalogManager:
    ...
    def add_stream(
        ...
        metadata: list[FlextCore.Types.Dict] | None = None,
    ...
    def get_stream(self, stream_name: str) -> FlextCore.Result[SingerWMSCatalogEntry]:
        """Get WMS stream from catalog."""
        if stream_name not in self._catalog_entries:
            return FlextCore.Result[SingerWMSCatalogEntry].fail(
                f"WMS stream not found: {stream_name}",
            )

        return FlextCore.Result[SingerWMSCatalogEntry].ok(
            self._catalog_entries[stream_name]
        )

    def list_streams(self: object) -> FlextCore.Result[FlextCore.Types.StringList]:
        """List all WMS streams in catalog."""
        try:
            streams = list(self._catalog_entries.keys())
            return FlextCore.Result[FlextCore.Types.StringList].ok(streams)
    ...
    def remove_stream(self, stream_name: str) -> FlextCore.Result[None]:
        ...
        try:
            ...
            return FlextCore.Result[None].fail(f"Stream removal failed: {e}")
    ...
    def get_schema_for_stream(
        ...
        stream_result: FlextCore.Result[object] = self.get_stream(stream_name)
        ...
        return FlextCore.Result[FlextCore.Types.Dict].ok(stream_entry.schema_info)
    ...
    def get_key_properties(
        ...
        return FlextCore.Result[FlextCore.Types.StringList].ok(
            stream_entry.key_properties
        )

    def update_stream_metadata(
        self,
        stream_name: str,
        metadata: list[FlextCore.Types.Dict],
    ) -> FlextCore.Result[None]:
        ...
        try:
            ...
            # Create updated entry with new metadata (FlextCore.Models is immutable)
            ...
            return FlextCore.Result[None].fail(f"Metadata update failed: {e}")

    def to_singer_catalog(self: object) -> FlextCore.Result[FlextCore.Types.Dict]:
        ...
        try:
            ...
            catalog: FlextCore.Types.Dict = {"streams": "streams"}
    ...
    def load_from_singer_catalog(
        ...
        try:
            ...
            streams: FlextCore.Types.List = catalog.get("streams", [])
            ...
            for stream_dict in streams:
                ...
                schema_info: FlextCore.Types.Dict = stream_dict.get("schema", {})
                metadata: FlextCore.Types.Dict = stream_dict.get("metadata", [])
                key_properties: FlextCore.Types.List = stream_dict.get(
                    "key_properties", []
                )
                bookmark_properties: FlextCore.Types.List = stream_dict.get(
                    "bookmark_properties", []
                )
            ...
            return FlextCore.Result[None].fail(f"Catalog loading failed: {e}")
...
class WMSStreamProcessingStats:
    ...
    def __init__(
        ...
        self.errors: FlextCore.Types.StringList = []
...
class SingerWMSStreamProcessor:
    ...
    def initialize_stream(
        ...
        try:
            # Validate schema structure (schema is already typed as FlextCore.Types.Dict)
    ...
    def process_record(
        ...
        try:
            if stream_name not in self._stream_stats:
                init_result: FlextCore.Result[object] = self.initialize_stream(
                    stream_name, {}
                )
            ...
            transform_result: FlextCore.Result[object] = (
    ...
    def process_batch(
        ...
        try:
            ...
            for record in records:
                process_result: FlextCore.Result[object] = self.process_record(
                    stream_name, record
                )
            ...
            return FlextCore.Result[list[FlextCore.Types.Dict]].ok(processed_records)
    ...
    def get_stream_stats(
        self,
        stream_name: str,
    ) -> FlextCore.Result[WMSStreamProcessingStats]:
        """Get processing statistics for WMS stream."""
        if stream_name not in self._stream_stats:
            return FlextCore.Result[WMSStreamProcessingStats].fail(
                f"WMS stream not found: {stream_name}",
            )

        return FlextCore.Result[WMSStreamProcessingStats].ok(
            self._stream_stats[stream_name]
        )

    def get_all_stats(
        self: object,
    ) -> FlextCore.Result[dict[str, WMSStreamProcessingStats]]:
        """Get all WMS stream processing statistics."""
        try:
            return FlextCore.Result[dict["str", "WMSStreamProcessingStats"]].ok(
                self._stream_stats.copy(),
            )

        except (RuntimeError, ValueError, TypeError) as e:
            logger.exception("Failed to get WMS stream statistics")
            return FlextCore.Result[dict["str", "WMSStreamProcessingStats"]].fail(
                f"Statistics retrieval failed: {e}",
            )

    def reset_stream_stats(self, stream_name: str) -> FlextCore.Result[None]:
        ...
        try:
            ...
            return FlextCore.Result[None].fail(f"Statistics reset failed: {e}")
    ...
    def finalize_stream(
        ...
        try:
            ...
            return FlextCore.Result[WMSStreamProcessingStats].ok(stats)
    ...
    def validate_record_schema(
        self,
        record: FlextCore.Types.Dict,
        expected_schema: FlextCore.Types.Dict,
    ) -> FlextCore.Result[bool]:
        """Validate WMS record against expected schema."""
        try:
            properties: FlextCore.Types.Dict = expected_schema.get("properties", {})
            ...
            return FlextCore.Result[bool].ok(validation_passed)
    ...
    def handle_schema_change(
        self,
        stream_name: str,
        old_schema: FlextCore.Types.Dict,
        new_schema: FlextCore.Types.Dict,
    ) -> FlextCore.Result[None]:
        ...
        try:
            ...
            old_props: FlextCore.Types.Dict = old_schema.get("properties", {})
            new_props: FlextCore.Types.Dict = new_schema.get("properties", {})
            ...
            return FlextCore.Result[None].fail(f"Schema change handling failed: {e}")
...
class SingerTargetOracleWMS:
    ...
    def __init__(self, config: FlextCore.Types.Dict) -> None:
        ...
        environment_mapping: FlextCore.Types.StringDict = {
            "dev": "development",
            "test": "test",
            "prod": "production",
        ...
        mapped_environment: FlextCore.Types.Config.Environment
        ...
        self.data_transformer: FlextCore.Types.Dict = WMSDataTransformer()
    ...
    def setup(self) -> FlextCore.Result[None]:
        """Set up Oracle WMS Target using REAL flext-oracle-wms client."""
        try:
            # Start Oracle WMS client - REAL API
            start_result: FlextCore.Result[object] = self.oracle_client.initialize()
    ...
    def process_lines(
        self,
        input_lines: FlextCore.Types.StringList,
    ) -> FlextCore.Result[None]:
    ...
    def _handle_schema_message(self, message: FlextCore.Types.Dict) -> None:
        """Handle Singer SCHEMA message."""
        try:
            stream_name = str(message.get("stream", ""))
            schema: FlextCore.Types.Dict = message.get("schema", {})
            ...
            add_result: FlextCore.Result[object] = self.catalog_manager.add_stream(
                stream_name, schema
            )
    ...
    def _handle_record_message(self, message: FlextCore.Types.Dict) -> None:
        """Handle Singer RECORD message."""
        try:
            stream_name = str(message.get("stream", ""))
            record: FlextCore.Types.Dict = message.get("record", {})
    ...
    def _handle_state_message(self, message: FlextCore.Types.Dict) -> None:
        """Handle Singer STATE message."""
        try:
            state: FlextCore.Types.Dict = message.get("value", {})
    ...
    @override
    def run(self: object) -> FlextCore.Result[None]:
        ...
        try:
            ...
            return FlextCore.Result[None].fail(f"Target execution failed: {e}")

    def handle_schema_message(self, message: FlextCore.Types.Dict) -> None:
        """Public method to handle schema messages."""
        self._handle_schema_message(message)

    def handle_record_message(self, message: FlextCore.Types.Dict) -> None:
        """Public method to handle record messages."""
        self._handle_record_message(message)

    def handle_state_message(self, message: FlextCore.Types.Dict) -> None:
