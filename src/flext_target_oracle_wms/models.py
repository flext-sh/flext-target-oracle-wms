...
class FlextTargetOracleWmsModels(FlextModels):
    ...
    class TargetOracleWms:
        """TargetOracleWms domain namespace."""
        ...
        class WmsInventoryItem(FlextModels.Entity):
            ...
            item_id: str = Field(
                ...,
                description="WMS item identifier",
                min_length=1,
                max_length=50,
            )
            ...
            lot_controlled_flag: bool = Field(
                default=False,
                description="Lot control enabled",
            )
        ...
        class WmsInventoryLocation(FlextModels.Entity):
            ...
            location_id: str = Field(
                ...,
                description="WMS location identifier",
                min_length=1,
                max_length=50,
            )
        ...
        class WmsTargetConfig(FlextModels.BaseConfig):
            ...
            stream_maps: dict[str, dict[str, str]] = Field(
                ...
                description="Stream to WMS entity mappings",
            )
            ...
            enable_bulk_binding: bool = Field(
                default=True,
                description="Enable bulk database operations",
            )

            # Validation configuration
            validate_records: bool = Field(
                default=True,
                description="Enable record validation",
            )
            validate_item_codes: bool = Field(
                default=True,
                description="Validate item codes against WMS",
            )
            validate_location_codes: bool = Field(
                default=True,
                description="Validate location codes against WMS",
            )
            enable_business_rule_validation: bool = Field(
                default=True,
                description="Enable WMS business rule validation",
            )
        ...
        class WmsTargetResult(FlextModels.Entity):
            ...
            average_processing_time_ms: float = Field(
                default=0.0,
                ge=0.0,
                description="Average per-record time",
            )
            ...
            wms_operations_executed: dict[str, int] = Field(
                default_factory=dict,
                description="WMS operations executed by type",
            )
        ...
        class WmsErrorContext(FlextModels.BaseModel):
            ...
            record_id: str | None = Field(
                None,
                description="Record identifier causing error",
            )
