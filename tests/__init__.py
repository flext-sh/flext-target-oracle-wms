...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "TestsFlextTargetOracleWmsConstants": ("tests.constants", "TestsFlextTargetOracleWmsConstants"),
    "TestsFlextTargetOracleWmsModels": ("tests.models", "TestsFlextTargetOracleWmsModels"),
    "TestsFlextTargetOracleWmsProtocols": ("tests.protocols", "TestsFlextTargetOracleWmsProtocols"),
    "TestsFlextTargetOracleWmsTypes": ("tests.typings", "TestsFlextTargetOracleWmsTypes"),
    "TestsFlextTargetOracleWmsUtilities": ("tests.utilities", "TestsFlextTargetOracleWmsUtilities"),
