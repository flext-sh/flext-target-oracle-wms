...
async def run_advanced_configuration_example() -> None:
    ...
    try:
        ...
        logger.error(f"Advanced configuration example failed: {e}")
        raise
    finally:
...
if __name__ == "__main__":
    ...
    print("🚀 Oracle WMS Target - Advanced Configuration Example")
    print("====================================================")
    
    print("\n1. Running advanced configuration example...")
    asyncio.run(run_advanced_configuration_example())
    
    print("\n2. Demonstrating custom components...")
