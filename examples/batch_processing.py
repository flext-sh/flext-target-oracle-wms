...
async def run_performance_batch_example() -> None:
    ...
    try:
        ...
        logger.error(f"Performance batch example failed: {e}")
        raise
    finally:
...
if __name__ == "__main__":
    ...
    print("⚡ Oracle WMS Target - Batch Processing Examples")
    print("===============================================")
    
    print("\n1. Running performance batch processing...")
    asyncio.run(run_performance_batch_example())
    
    print("\n2. Demonstrating stream processor batching...")
    asyncio.run(demonstrate_stream_processor_batching())
    
    print("\n3. Demonstrating concurrent batch processing...")
